...
class Create extends AbstractPlugin
{
    ...
    public function __invoke($user, $timeStart, $timeEnd, $dateStart, $dateEnd, $repeat, $square, $statusBilling, $quantity, $notes = null, $creator = null, $teacher = null, $constructions = null)
    {
        ...
        try {
            ...
            $bookingMeta['teacher'] = $teacher;
            $bookingMeta['constructions'] = $constructions;
